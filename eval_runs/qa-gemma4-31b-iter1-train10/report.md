# Q&A citation eval: qa-gemma4-31b-iter1-train10
...
**Citation hit rate (clause present): 0.68** (42/62)
**Absence handling (clause absent, no citation): 0.83** (65/78)

Strict IoU >= 0.3 hit rate (for reference): 0.50 (31/62)
